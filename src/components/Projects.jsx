...
const projects = [
  ...
  },
  {
    id: 'spectral',
    emoji: '🌐',
    tag: '💻 computational chemistry Project',
    title: 'Spectral',
    desc: 'A live deployed web project built and hosted on Vercel, showcasing frontend development skills with a clean, modern interface.Based on core concepts of quantum chemistry, especially the Rydberg formula and Bohr model.',
    stack: ['React', 'Vite', 'CSS', 'Vercel'],
    bannerBg: 'linear-gradient(135deg, #000a1a, #001a2e)',
    accentColor: '#00A8FF',
    github: 'https://github.com/Dhirendra10251',
    live: 'https://spectral-tau.vercel.app',
  },
]
