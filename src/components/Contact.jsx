...
const FORMSPREE_ENDPOINT = 'https://formspree.io/f/xpwrlgoj' // ← replace with your real Formspree form ID after signup at formspree.io
    ...
    <footer className="footer" role="contentinfo">
      <div className="container">
        <p className="footer-text">
          Built with 🔥 by <strong>Dhirendra Kumar Thakur</strong> &middot; 2026
        </p>
